...
export const frFr: Translations = {
    ...
    stream: {
        ...
        clipboardCopyHint: "Copie automatique indisponible - maintenez le texte pour copier manuellement",
        clipboardDeviceToHost: "Envoyer du texte vers le presse-papiers de l'hôte",
        clipboardSend: "Envoyer à l'hôte",
        clipboardSent: "Envoyé - presse-papiers de l'hôte mis à jour",
        clipboardSendFailed: "Échec de l'envoi à l'hôte",
        clipboardUpdated: "Presse-papiers de l'hôte mis à jour",
