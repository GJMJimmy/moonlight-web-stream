...
export const koKR: Translations = {
    ...
    stream: {
        ...
        clipboardCopyHint: "자동 복사 불가 - 텍스트를 길게 눌러 직접 복사하세요",
        clipboardDeviceToHost: "호스트 클립보드로 텍스트 보내기",
        clipboardSend: "호스트로 보내기",
        clipboardSent: "전송됨 - 호스트 클립보드가 업데이트되었습니다",
        clipboardSendFailed: "호스트 전송 실패",
        clipboardUpdated: "호스트 클립보드가 업데이트되었습니다",
        rootNotFound: "루트 요소를 찾을 수 없습니다.",
    },
    settings: {
        sidebar: "사이드바",
