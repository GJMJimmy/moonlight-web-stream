export const en = {
    ...
    stream: {
        ...
        clipboardCopyHint: "Auto copy unavailable - long-press the text to copy manually",
        clipboardDeviceToHost: "Send text to the host clipboard",
        clipboardSend: "Send to host",
        clipboardSent: "Sent - host clipboard updated",
        clipboardSendFailed: "Failed to send to host",
        clipboardUpdated: "Host clipboard updated",
        rootNotFound: "couldn't find root element",
    },
    settings: {
        sidebar: "Sidebar",
