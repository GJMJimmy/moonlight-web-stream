...
export const ptBR: Translations = {
    ...
    stream: {
        ...
        clipboardCopyHint: "Cópia automática indisponível - segure o texto para copiar manualmente",
        clipboardDeviceToHost: "Enviar texto para a área de transferência do host",
        clipboardSend: "Enviar ao host",
        clipboardSent: "Enviado - área de transferência do host atualizada",
        clipboardSendFailed: "Falha ao enviar ao host",
        clipboardUpdated: "Área de transferência do host atualizada",
        rootNotFound: "elemento raiz não encontrado",
    },
    settings: {
